...
document.write(`<h2 style="color:#8A9F70">welcome dear guest: <span style="color:#D699B6"> ${person[0]}</span> </h2>`);
document.write(`<h2 style="color:#8A9F70">your telephone number is: <span style="color:#D699B6"> ${person[1]}</span>  </h2>`);
document.write(`<h2 style="color:#8A9F70">your mobile number is: <span style="color:#D699B6"> ${person[2]}</span>  </h2>`);
document.write(`<h2 style="color:#8A9F70">your email is: <span style="color:#D699B6"> ${person[3]}</span>  </h2>`);
