...
document.write(`<h2 color="#8A9F70">welcome dear guest: ${person[0]} </h2>`)
document.write(`<h2 color="#8A9F70">your telephone number is: ${person[1]} </h2>`)
document.write(`<h2 color="#8A9F70">welcome dear guest ${person[2]} </h2>`)
document.write(`<h2 color="#8A9F70">welcome dear guest ${person[3]} </h2>`)