...
def perform_classification():
    ...
    y_train_indeices = []
    for i in range(len(nn2.y_train)):
        for j in range(len(nn2.y_train[i])):
            if nn2.y_train[i][j] == 1:
                y_train_indeices.append(j)
