...
def perform_prediction():
    ...
    # print("#####################################################")
    predict_input = np.array(predict_input).reshape(2, 6)
    ...
    prediction = nn2.predict(predict_input, neurons_num, net, act_func_option.get(), hidden_layers_num)
...
def perform_classification():
    ...
    # print("[hidden_layers_num]: ", hidden_layers_num )
