...
def predict_window():
    ...
    global get_precit_input

    def get_precit_input():
...
def perform_prediction():
    ...
    print("[net]: ", net)
    print("[act_func_option]: ", act_func_option)
    print("#####################################################")
    prediction = nn2.predict(predict_input, neurons_num, net, act_func_option)
...
def perform_classification():
    ...
    print("[act_func_option]: ", act_func_option.get())
    print("[Learn_rate]: ", learn_rate)
    print("[epochs_num]: ", epochs_num )
    
    global net
    net = nn2.train(nn2.x_train, nn2.y_train, hidden_layers_num, neurons_num, act_func_option, learn_rate, epochs_num)
