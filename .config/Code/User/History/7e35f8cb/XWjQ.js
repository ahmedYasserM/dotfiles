...
function ChangeBorderColor(color) {
  switch (color) {
    case `none`:
      ...
      break;
    case `pink`:
      text.style = `border-style: pink`;
      break;
    case `red`:
      text.style = `border-style: red`;
      break;
    case `green`:
      text.style = `border-style: green`;
      break;
    case `blue`:
      text.style = `border-style: blue`;
      break;
    case `yellow`:
      text.style = `border-style: yellow`;
      break;
    case `purple`:
      text.style = `border-style: purple`;
      break;
  }
}
