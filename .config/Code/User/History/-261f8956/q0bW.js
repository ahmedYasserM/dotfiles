...
let angle = Number.parseFloat(prompt(`What is the angle you want to calculate its cos value`)).toFixed(2)
document.write(`<h3> cos ${angle}<sup>o</sup> is ${Math.cos(180 * (Math.PI / 180))} </h3>`)
