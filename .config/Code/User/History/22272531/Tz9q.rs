...
// the lifetime enusures that the data referenced by some  reference can live until last use of that reference
// references in c++ are automatically dereferenced pointers