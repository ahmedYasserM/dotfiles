return {
  {
    ...
    config = function()
      ...
      vim.api.nvim_set_hl(0, "LspInlayHint", { bg = "NONE", fg = "#5F6375" })
    end,
  },
    ...
    config = function()
      require("tokyonight").setup({
        ...
        on_colors = function(colors)
          colors.bg = "#0D0F18"
          colors.bg_dark = "#0D0F18"
          colors.bg_dark1 = "#0D0F18"
          colors.bg_float = "#0D0F18"
          colors.bg_highlight = "#0D0F18"
          colors.bg_popup = "#0D0F18"
          colors.bg_search = "#0D0F18"
          colors.bg_sidebar = "#0D0F18"
          colors.bg_statusline = "#0D0F18"
        end,
      })
  ...
  --         snacks = {
  --           enabled = true,
  --           -- indent_scope_color = "lavender", -- catppuccin color (eg. `lavender`) Default:
  --         },
