...
static const char *fonts[]          = {"JetBrainsMonnsMono Nerd Font Mono:style:small:size=12"};
static const int splitstatus        = 1;        /* 1 for split status items */
static const char *splitdelim        = ";";       /* Character used for separating status */
static const char dmenufont[]       = "JetBrainsMonnsMono Nerd Font Mono:style:small:size=13";
